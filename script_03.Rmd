...
-acknowledge that the data can't tell us about outside factors that influence why students are drop courses
-understand that one person's history, reasoning, or experience with taking a leave of absence or not enrolling in classes does not necessarily affect another person's history, reasoning, or experience
-care about the people who we do not interview or survey to find out the case in drop in undergraduate enrollment

After we have a model, Temperance suggests we should:

-accept that there is uncertainty in our models and not take them to be completely accurate
-acknowledge that our model is subject to change since observations of the real world are constantly shifting
-be discreet and honest when randomization is impossible
-try and ensure validity through an accurate representation of our information in the form of a graphic
...
sep_change <- sep_old %>%
  ...
  mutate(enrollment_change = u_grad.y - u_grad.x) %>% 
